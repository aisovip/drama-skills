...
道具 plate 要让后续画面保持同一件物体的轮廓、尺度、材料、功能和当前状态。输入是精确 Prop/PState、来源指针、用途、尺度参照、视角、功能件、磨损/损坏、主人关联、文字政策、背景与光线。
...
| 问题 | 分类 |
|---|---|
| Prop/PState、source refs、text policy 可解析且不冲突 | `structural_invariant` |
